...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.exit_btn_2.clicked.connect(self.exitProgram) # type: ignore
        self.exit_btn_1.clicked.connect(self.exitProgram) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

        #closing app
        #closing app
    def exitProgram(self):
        quit = QMessageBox(self.centralwidget)
        quit.setWindowTitle('Quit Application')
        quit.setText("If there's any unfinished process, it will stop\nand you will lose any unsaved data. Are you sure you want to continue?")
